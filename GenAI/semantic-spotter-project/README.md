...
- Clone the github repository
  ```shell
  $ git clone https://github.com/Sanyamkumar9999/upgrad2024/tree/master/GenAI/semantic-spotter-project
  ```
- Open
  the [notebook](https://github.com/Sanyamkumar9999/upgrad2024/blob/master/GenAI/semantic-spotter-project/semantic-spotter-langchain-notebook.ipynb)
